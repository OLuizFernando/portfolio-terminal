...
export const ptDocs: Record<string, CommandDocs> = {
  ...
  reboot: {
    ...
    usage: 'reboot',
    man:
      'Remonta o filesystem do zero e roda a sequência de boot de novo.\n\n' +
  ...
  date: {
    ...
    usage: 'date',
    man: 'Mostra o seu relógio, no seu fuso — não o da máquina. O Pi mora no\nBrasil; você talvez não.',
  },
  uname: {
  ...
  ps: {
    ...
    usage: 'ps [aux]',
    man:
      'Os processos que estão rodando na máquina agora. Ordenados por CPU,\n' +
  ...
  neofetch: {
    ...
    usage: 'neofetch',
    man:
      'A máquina com quem você está falando, descrita por ela mesma.\n\n' +
      'Todo número aqui foi lido do /proc há um instante. A temperatura é a\n' +
      'temperatura de verdade de uma placa numa prateleira no Brasil.',
  },
  top: {
    summary: 'acompanha a máquina ao vivo',
    usage: 'top',
    man:
      'Repinta a cada dois segundos com o que a máquina está fazendo, até você\n' +
  ...
  font: {
    ...
    usage: 'font [<px> | reset]',
    man:
      'Muda o tamanho do texto, e lembra dele na próxima vez.\n\n' +
  ...
  sudo: {
    ...
    man:
      'Roda um comando como root, e ele roda como root mesmo.\n\n' +
      ...
      'própria aba — o Raspberry Pi nunca fica sabendo.\n\n' +
  ...
  fortune: {
    ...
    usage: 'fortune',
    man:
      'Imprime um dos epigramas de /usr/share/fortunes, ao acaso.\n\n' +
  ...
  matrix: {
    ...
    usage: 'matrix',
    man:
      'Chuva digital, no terminal em que você já está.\n\n' +
  ...
  crt: {
    ...
    usage: 'crt [on | off]',
    man:
      'Transforma o terminal no monitor que esta coisa toda finge ser:\n' +
